...
One of the **most** requested features in both the focus group and interviews was to have a system in place to track availability, which we worked to make sure was present in the wireframes. Because of the large disparity between possible users and their experiences, we did our best to ensure that all groups have a good experience. Furthermore, people can be in several groups at the same time. On top of people who both are game masters and palyers, one can be an experienced player but want to learn how to be a Game Master, or vice versa. In order to meet these cases, we made sure that it was fast and easy to transition from being a player and finding a game, as well as being a Game Master and creating a game. 
